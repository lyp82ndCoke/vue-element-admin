    ...
    <el-col :span="24" class="title-header">
      ...
      <el-col 
        ...
        <el-input
          ...
          v-model="listQuery.qr_code_name"
          clearable>
        </el-input>
      </el-col>
      ...
      <el-col :span="6" align="center">
        <el-select
          ...
          clearable
          @change="searchCode"
          v-model="listQuery.qr_code_type"
          placeholder="请选择二维码类型"
        >
          <el-option
            v-for="item in [{ label: '群',value: 1},{label:'管理员', value: 2}]"
            :key="item.value"
            :label="item.label"
            :value="item.value"
          ></el-option>
...
import { getSourcesList, addSources, updateSources } from '@/api/goodMother'
