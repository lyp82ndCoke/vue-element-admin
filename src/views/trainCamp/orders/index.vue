    ...
    <el-col :span="24" class="title-header">
      ...
      <el-col :span="6" align="right">
        ...
        <el-select
          ...
          placeholder="支付状态"
        >
          <el-option v-for="item in payOptions" :label="item.label" :value="item.value" :key="item.index"></el-option>
        </el-select>
      </el-col>
    </el-col>
...
export default {
  ...
  created() {
    this.getOrderList()
    this.listQuery.mobile = sessionStorage.getItem('checkOrder') ? sessionStorage.getItem('checkOrder') : '';
  },
  methods: {
    // 获取订单list
    getOrderList() {
