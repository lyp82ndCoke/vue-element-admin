<template>
  <div class="app_container">
    <el-col :span="24" class="title-header">
      <el-col :span="24" class="title">任务规则 - 商品任务</el-col>
    </el-col>
    <el-col :span="6" class="title-content">
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="完成条件">
          <el-radio v-model="radio1" label="1" >下单完成</el-radio>
        </el-form-item>
        <el-form-item>
...
import { getItemList } from "@/api/shopGoods";
...
export default {
  ...
  created(){
    this.editItem = JSON.parse(sessionStorage.getItem('editItem'));
    if(this.editItem){
      this.item.item_id = this.editItem.item_id;
      this.item_task_id = this.editItem.item_task_id;
      this.item.item_name = this.editItem.item_name;
      this.form.remarks = this.editItem.remarks;
    }
  },
  methods:{
    loadCamplist(){
    ...
    selectGoods(){
      ...
      this.getItemList();
      console.log('selectGoods',this.form);
    },
    selectGoods2(){
      this.item = {};
      this.dialogFormVisible = true;
    ...
    onSubmit(){
      let params = {
        task_type: 1,
        task_id: this.item_task_id,
        item_id: this.item.item_id,
        item_name: this.item.item_name,
        remarks: this.form.remarks,
        card_target_num:'',
      }
      if(this.item_task_id){
    ...
    handleSelectionChange(val) {
      ...
      }else if(val.length == 0 && this.editItem != null){
        this.item.item_id = this.editItem.item_id;
        this.item_task_id = this.editItem.item_task_id;
        this.item.item_name = this.editItem.item_name;
        this.form.remarks = this.editItem.remarks;
